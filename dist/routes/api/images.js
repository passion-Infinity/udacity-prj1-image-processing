...
images.get('/', logger_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, file_1.default.validate(req.query)];
            case 1:
                ...
                error = '';
                return [4 /*yield*/, file_1.default.checkAvailableThumb(req.query)];
            case 2:
            ...
            case 4:
                ...
                return [4 /*yield*/, file_1.default.getImagePath(req.query)];
            case 5:
                path = _a.sent();
                if (path) {
                    res.sendFile(path);
